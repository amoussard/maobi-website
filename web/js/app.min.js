...
jQuery(document).ready(function($){
	var timelines = $('.rp-horizontal-timeline'),
	...
	function initTimeline(timelines) {
		timelines.each(function(){
			...
			timelineComponents['timelineNavigation'] = timeline.find('.rp-timeline-navigation');
	...
	*/
	...
	function checkMQ() {
		...
		return window.getComputedStyle(document.querySelector('.rp-horizontal-timeline'), '::before').getPropertyValue('content').replace(/'/g, "").replace(/"/g, "");
	}
});
