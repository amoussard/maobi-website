...
var Grid = (function() {
	...
	Preview.prototype = {
		create : function() {
			...
			this.$href = $( '<a class="visitBtn" href="#">Visit website</a>' );
		...
		update : function( $item ) {
			...
			var $itemText = this.$item.children('.description').html();
				
		
			this.$title.html( eldata.title );
			this.$description.html($itemText);
